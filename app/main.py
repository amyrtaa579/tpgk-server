...
from app.presentation.files_routes import create_files_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(create_v1_router(), prefix=settings.api_v1_prefix)
    app.include_router(create_files_router(), prefix=settings.api_v1_prefix)
    app.include_router(create_auth_router(), prefix=settings.api_v1_prefix)
    app.include_router(create_admin_users_router(), prefix=settings.api_v1_prefix)
    app.include_router(create_admin_specialties_router(), prefix=settings.api_v1_prefix)
    app.include_router(create_admin_news_router(), prefix=settings.api_v1_prefix)
    app.include_router(create_admin_facts_router(), prefix=settings.api_v1_prefix)
    app.include_router(create_admin_upload_router(), prefix=settings.api_v1_prefix)
    app.include_router(create_admin_gallery_router(), prefix=settings.api_v1_prefix)
    app.include_router(create_admin_document_files_router(), prefix=settings.api_v1_prefix)
    app.include_router(create_admin_faq_router(), prefix=settings.api_v1_prefix)
    app.include_router(create_admin_documents_router(), prefix=settings.api_v1_prefix)
    app.include_router(create_admin_about_router(), prefix=settings.api_v1_prefix)
    app.include_router(create_admin_test_router(), prefix=settings.api_v1_prefix)
    app.include_router(create_admin_cache_router(), prefix=settings.api_v1_prefix)
    app.include_router(create_admin_admission_router(), prefix=settings.api_v1_prefix)
